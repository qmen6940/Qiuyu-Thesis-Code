...
#classes = ['Paet1','Paet2','Paet3','Paet4']
classes = ['Stem','Foliage','Shrub','Ground',]
...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=6, help='batch size in testing [default: 32]')
    parser.add_argument('--gpu', type=str, default='0', help='specify gpu device')
    parser.add_argument('--num_point', type=int, default=4096, help='point number [default: 4096]')
    parser.add_argument('--log_dir', type=str, default='2024-02-06_16-57', help='experiment root')
